...
namespace CertificationCoreWeb.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(Context Db, UserManager<CustomMembershipUser> userManager, SignInManager<CustomMembershipUser> signInManager, RoleManager<IdentityRole> roleManager ):base(Db)
        {
            _db = Db;
