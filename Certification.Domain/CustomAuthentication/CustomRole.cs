...
namespace CertificationWeb.CustomAuthentication
{
    public class CustomRole
    {
        ...
        public CustomRole(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager,
        ...
        {
            var usersInRole = await _userManager.GetUsersInRoleAsync(roleName);
            var matchingUsers = usersInRole.Where(u => u.UserName.Contains(usernameToMatch)).Select(u => u.UserName)
                .ToArray();
